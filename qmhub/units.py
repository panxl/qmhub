...
# COULOMB_CONSTANT = 332.05221729 # AmberTools

# AmberTools Constants
AMBER_EV_TO_KCAL = 23.061
AMBER_AU_TO_EV = 27.21
AMBER_AU_TO_KCAL = AMBER_AU_TO_EV * AMBER_EV_TO_KCAL
AMBER_BOHRS_TO_A = 0.529177249
AMBER_FORCE_AU_TO_IU = AMBER_AU_TO_KCAL / AMBER_BOHRS_TO_A
